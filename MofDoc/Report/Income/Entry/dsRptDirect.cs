...
{
    public partial class dsRptDirect : XtraReport
    {
        ...
        public dsRptDirect(string reportName, string userName, string startDate, string endDate, string totalDoc, string totalPageNum, List<Document> parameter)
        {
            InitializeComponent();
