...
{
    public partial class DirectRegisterWizard : XtraForm
    {
        ...
        public DirectRegisterWizard(string dbName)
        {
            InitializeComponent();
            this.dbName = dbName;
            InitControl();
        ...
        private void InitControl()
        {
            ...
            dateDoc.Tag = dateRegistered.Tag = "Огноог тодорхойлно уу.";
        }
